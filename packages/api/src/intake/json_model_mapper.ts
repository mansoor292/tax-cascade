...
const FUZZY_RULES_1120S: FuzzyRule[] = [
  ...
  // Additional patterns for the 1120S return's full Schedule K
  { pattern: /10\s+other\s+income.*loss.*(?:see\s+instr)?/,                                       canonical_key: 'schedK.L10_other_amount',      confidence: 0.92 },
  { pattern: /12a\s+cash\s+charitable|12a\s+cash\s+contributions/,                                canonical_key: 'schedK.L12a_cash_charity',     confidence: 0.93 },
  { pattern: /12b\s+noncash\s+charitable|12b\s+noncash\s+contributions/,                          canonical_key: 'schedK.L12b_noncash_charity',  confidence: 0.93 },
  { pattern: /12c\s+investment\s+interest\s+expense/,                                              canonical_key: 'schedK.L12c_invest_interest',  confidence: 0.93 },
  { pattern: /15b\s+adjusted\s+gain/,                                                              canonical_key: 'schedK.L15b_adj_gain',         confidence: 0.92 },
  { pattern: /15c\s+depletion.*other.*oil/,                                                       canonical_key: 'schedK.L15c_depletion',        confidence: 0.92 },
  { pattern: /15d\s+oil.*gas.*gross/,                                                             canonical_key: 'schedK.L15d_oil_gross',        confidence: 0.92 },
  { pattern: /15e\s+oil.*gas.*deductions/,                                                        canonical_key: 'schedK.L15e_oil_ded',          confidence: 0.92 },
  { pattern: /15f\s+other\s+amt/,                                                                  canonical_key: 'schedK.L15f_other_amt',        confidence: 0.91 },
  { pattern: /16a\s+tax-exempt\s+interest/,                                                       canonical_key: 'schedK.L16a_tax_exempt_int',   confidence: 0.93 },
  { pattern: /16b\s+other\s+tax-exempt/,                                                          canonical_key: 'schedK.L16b_other_exempt',     confidence: 0.92 },
  { pattern: /16c\s+nondeductible\s+expenses/,                                                    canonical_key: 'schedK.L16c_nondeductible',    confidence: 0.93 },
  { pattern: /16f\s+foreign\s+tax/,                                                                canonical_key: 'schedK.L16f_foreign_taxes',    confidence: 0.92 },
  { pattern: /17c\s+dividend.*distributions.*accumulated/,                                         canonical_key: 'schedK.L17c_div_from_ae',      confidence: 0.92 },
  // Schedule B — other information checkboxes/counts
  { pattern: /5a.*total\s+shares.*restricted/,                                                    canonical_key: 'schedB.L5a_restricted',        confidence: 0.91 },
  { pattern: /5a.*total\s+shares.*non-?restricted/,                                                canonical_key: 'schedB.L5a_nonrestricted',     confidence: 0.91 },
  { pattern: /5b.*total\s+shares\s+outstanding.*eoy|5b.*outstanding.*tax\s+year/,                  canonical_key: 'schedB.L5b_outstanding',       confidence: 0.91 },
  { pattern: /5b.*total\s+shares.*if.*all.*instruments/,                                           canonical_key: 'schedB.L5b_if_executed',       confidence: 0.91 },
