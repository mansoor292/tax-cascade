/**
 * Enumerate every form field on f1040se_{year}.pdf so we can extend the
 * current summary-only field map with per-property grid cells.
 *
 * Run: npx tsx packages/api/scripts/enum_sche.ts [year]
 */
